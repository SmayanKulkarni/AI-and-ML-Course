def calculate_priority_scheduling_times(burst_times, priorities):
    n = len(burst_times)
...
burst_times = [9, 4, 9]
priorities = [2, 1, 3]
average_waiting_time, average_turnaround_time = calculate_priority_scheduling_times(burst_times, priorities)
